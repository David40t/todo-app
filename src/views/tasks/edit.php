...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-lg">
    ...
    <form action="/tasks/update/<?= $task['id'] ?>" method="POST" class="space-y-6">
        ...
        <div>
            ...
            <textarea id="description" name="description" rows="4" 
                      class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-indigo-500 focus:outline-none"><?= htmlspecialchars($task['description']) ?></textarea>
        </div>
